    ...
    public class PeliculaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Peliculas != null ? 
                          ...
                          Problem("Entity set 'CineDatabaseContext.Peliculas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,titulo,genero")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,titulo,genero")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CineDatabaseContext.Peliculas'  is null.");
            }
            var pelicula = await _context.Peliculas.FindAsync(id);
            if (pelicula != null)
            {
